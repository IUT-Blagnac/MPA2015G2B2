...
public class CreerInterv extends JDialog{
	...
	public CreerInterv(JFrame mere, String titre, Controller c, Etudiant e){
		this(mere, titre, c);
		this.mod = true;
	...
	public CreerInterv(JFrame mere, String titre, Controller c){
		...
		buttonsPanel.add(addB);
			addB.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					if(mod)
						ctrl.modifierInterv(new Intervenant(idEtuM, nom.getText(), prenom.getText()));
					else
						ctrl.creationInterv(new Intervenant(nom.getText(), prenom.getText()));
					dispose();
				}
			});
