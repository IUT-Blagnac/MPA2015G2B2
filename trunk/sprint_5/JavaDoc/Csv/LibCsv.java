...
import Model.Sujet;
/**
 * Cette classe est une librairie qui permet de lire et écrire un fichier .CSV
 * @author Thomas
 *
 */
public class LibCsv {
	 ...
	 * 
	 * @param dataTab ArrayList de données
	 * @param csvPath Chemin d'accès du fichier .csv
	 * @throws Exception 
	 */
	 ...
	 * 
	 * @param csvPath Chemin d'accès du fichier .csv
	 * @return dataTab ArrayList de données
	 * @throws Exception 
	 */
	...
	public static  ArrayList<Sujet> translateArray( ArrayList<String[]> array) {
		...
		/**
	 * Transforme une ArrayList de Sujet en ArrayList de String[]
	 * @param array Une ArrayList de Sujet
	 * @return goodArray Une ArrayList de String[]
	 */
