...
/**
 * Cette classe est une JDialog qui affiche une fenêtre permettant à l'utilisateur d'entrer les différentes informations nécessaires à la création d'un Etudiant
 * @author Sorény
 *
 */
